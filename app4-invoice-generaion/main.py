...
for filepath in filepaths:
    ...
    # First value will be assigned for var1 and so on
    ...
    # Add a header. We don't need convert columns by list function, because here is iterable Index in df
    columns = df.columns
    ...
    # Add a comany name logo
    pdf.set_font(family="Times", size=14, style="B")
    pdf.cell(w=25, h=8, txt=f"PMC")
